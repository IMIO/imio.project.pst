...
def step_3(browser):
    ...
    browser.find(u"Type d'organisation").set_value('cpas')
...
class TestConfigureOrganizationType(FunctionalTestCase):
    ...
    Actor(s): pst admin
    Goal: allows actors to configure organisation type
    Author: Franck Ngaha
    Created: 04/02/2021
    Updated: 21/04/2021
    ...
    def main_scenario(self, browser, actor, context):
        ...
        step_3(browser)  # The actor update organization type field and save
