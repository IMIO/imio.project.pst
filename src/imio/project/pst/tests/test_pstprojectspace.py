...
class TestPSTProjectSpace(IntegrationTestCase):
    ...
    def test_default_setup(self):
        ...
        self.assertEquals(self.pst.pstaction_fields, self.ac_fields)
        self.assertEquals(self.pst.pstsubaction_fields, self.ac_fields)
        ...
        self.assertEquals(self.pst.pstactions_columns, self.ac_columns)
