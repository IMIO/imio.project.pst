...
def adaptDefaultPortal(site):
    ...
    site.manage_permission('imio.project.pst: ecomptes import', ('Manager', 'Contributor'), acquire=0)
    site.manage_permission('imio.project.pst: ecomptes export', ('Manager', 'Contributor'), acquire=0)
